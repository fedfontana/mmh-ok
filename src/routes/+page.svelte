...
<div class="flex flex-col gap-12 w-full mt-12">
	...
	<form class="mx-auto flex flex-col items-center gap-2 mt-24"
    ...
    >
		<!-- TODO copy styles from other inputs/buttons/labels -->
		...
		<button
            type="submit"
			class="px-4 py-2 border-2 border-green-900 bg-green-500 rounded-lg shadow-xl hover:scale-95 transition-all"
		>
			Search
		</button>
	</form>
